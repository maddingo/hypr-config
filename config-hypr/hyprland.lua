...
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("xdg-open 'https://'"))
...
hl.bind(mainMod .. " + Tab", hl.dsp.exec_cmd(ipc .. "plugin maddingo/hyprland-layout:poller all cycle"))
...
-- noctalia.lua is generated by Noctalia on first run, so it may not exist yet
-- the first time Hyprland parses this config (e.g. right after a fresh install).
