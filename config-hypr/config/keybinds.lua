...
hl.bind(mainMod .. " + K",          hl.dsp.exec_cmd(launchPrefix .. PASSWORDMGR))
-- hl.bind(mainMod .. " + J",          hl.dsp.exec_cmd(launchPrefix .. IDEA))
...
-- Media
hl.bind("XF86AudioPlay",  hl.dsp.exec_cmd(noctCall .. "media play"), { locked = true })
...
hl.bind(mainMod .. " + B",     hl.dsp.exec_cmd(noctCall .. "panel-toggle blackbartblues/keymap:panel"))
